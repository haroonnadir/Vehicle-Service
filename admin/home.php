          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $mechanics = $conn->query("SELECT sum(id) as total FROM `mechanics` where status = '1' ")->fetch_assoc()['total'];
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="shadow info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                  <?php 
                    $customers = $conn->query("SELECT sum(id) as total FROM `customers` where status = '1' ")->fetch_assoc()['total'];
                    echo number_format($customers);
                  ?>
                </span>
              </div>
              <!-- /.info-box-content -->
