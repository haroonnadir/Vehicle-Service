...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?> Customer</h3>
	</div>
	<div class="card-body">
		<form action="" id="customers-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="name" class="control-label">Full Name</label>
                <input name="name" id="name" type="text" class="form-control rounded-0" value="<?php echo isset($firstname) ? $firstname : ''; ?>" required>
			</div>
            <div class="form-group">
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="customers-form">Save</button>
		<a class="btn btn-flat btn-default" href="?page=customer">Cancel</a>
	</div>
</div>
<script>
