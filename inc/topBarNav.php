            ...
            <div class="container px-4 px-lg-5 ">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=register_customer">Cutstomer Registration</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=register_mechanic">Mechanic Registration</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=login_customer">Cutstomer Login</a></li>
                        <li class="nav-item"><a class="nav-link" href="./?p=login_mechanic">Mechanic Login</a></li>
                    </ul>
