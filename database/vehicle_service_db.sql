  ...
  CREATE TABLE `customers` (
    ...
    `location` varchar(250) NOT NULL, -- Added location field
    `status` tinyint(1) NOT NULL DEFAULT 1,
    `date_created` datetime NOT NULL DEFAULT current_timestamp(),
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `mechanics` (`id`, `name`, `username`, `password`, `contact`, `email`, `location`, `status`, `date_created`) VALUES
(1, 'John Doe', 'jdoe', 'hashed_password_here', '09123456789', 'jdoe@example.com', 'Sample Location', 1, '2021-12-04 00:00:00');
